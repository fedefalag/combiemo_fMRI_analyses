...
function cosmomvpaFuncRoiCrossValidation_visualRois(opt, funcFWHM)
...
for iSub = 1:length(opt.subjects)
        ...
        pathData = strcat(opt.derivativesDataDir,'sub-',subID,opt.derivExtension,'/');
...
%                 end
                ...
                roiPattern = fullfile(strcat(derivativesDir,'/derivatives/cpp_spm/sub-',subID,opt.derivExtension,'label-expandVox',num2str(opt.cosmomvpa.voxelNrByRoi(iRoi)),'_sub',subID,opt.cosmomvpa.rois(iRoi),'FWHM6',opt.thre,'mask.nii'));
